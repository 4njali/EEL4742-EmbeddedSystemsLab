...
/* main function
 * read and transmit x and y axis coordinate of joystick
 */
int main (void){
    ...
    unsigned int n = 1;
    // labels
    char mystring1[] = "X-axis:  ";
    char mystring2[] = "Y-axis:  ";
    ...
    for( ; ; ){ // infinite loop
        ...
        uart_write_string(mystring1);   // label x-axis
        uart_write_uint16(ADC12MEM0);   // transmit x-axis register
        uart_write_char('\n');
        uart_write_char('\r');

        uart_write_string(mystring2);   // label y-axis
        uart_write_uint16(ADC12MEM1);   // transmit y-axis register
        uart_write_char('\n');
        uart_write_char('\n');
        uart_write_char('\r');
...
void Initialize_ADC() {
    ...
    // Y-axis: A4/P8.7, P8DIR=x, P8SEL1=1, P8SEL0=1
    P8SEL1 |= BIT7;
    P8SEL0 |= BIT7;
    ...
    //*************** ADC12CTL3 ***************
    // Set ADD12CSTARTADD to 0 (first conversion in ADC12MEM0)
